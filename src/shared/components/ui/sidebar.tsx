...
function Sidebar({
  ...
  // Auto-expand on hover when in icon mode, collapse when not hovered
  React.useEffect(() => {
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden pointer-events-auto"
          style={
            {
